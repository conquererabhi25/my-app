      ...
      <>
        ...
        >
          ...
          <div className=" home-header-content heading-container">
            <h1
              className=" movie-details-name home-poster-title"
              key={title}
              testid="title"
            >
              {title}
      ...
      <div className="root-container">
        ...
        <div className="bottom-container">
          <div className="main-container">
            <h1 className="section-heading" key="Trending Now">
              Trending Now
            </h1>
          ...
          <div className="main-container">
            <h1 className="section-heading" testid="Top Rated">
              Top Rated
            </h1>
            <div className="slick-container">
              <TopRated />
          ...
          <div className="main-container">
            <h1 className="section-heading" key="Originals">
              Originals
            </h1>
            <div className="slick-container">
              <Originals />
